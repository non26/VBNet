Public Class Game
    ...
    Public Function checkAnswer() As Boolean
        If Me.personPlayer.predictor Then
            ...
            Dim numberOfO As Integer = CInt(Me.personPlayer.answer.Substring(lenAnswer - 1, 1))
        ...
        Else ' ai is the predicter
            ...
            Dim numberOfO As Integer = CInt(Me.aiPlayer.answer.Substring(lenAnswer - 1, 1))
            Dim restCharacter As String = ""
    ...
    Public Function letPlay() As Boolean
        Do While True
            ...
            getInput()
            Console.WriteLine("AI: " + Me.aiPlayer.answer)
